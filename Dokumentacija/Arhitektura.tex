...
\begin{longtblr}[
		...
		\section{Dijagram stanja}
			...
			Dijagram stanja (\ref{fig:dijagram_razreda_1}) prikazuje stanja i prijelaze između stanja u kojima se nalazi korisničko sučelje kada korisnik - pacijent koristi aplikaciju. Stanje u dijagramu predstavlja ekran (\textit{engl. screen}) u aplikaciji, a prijelaz predstavlja radnju korisnika kada koristi aplikaciju (klik na gumb ili ikonu).
