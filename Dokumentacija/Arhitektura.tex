...
\begin{longtblr}[
		...
		\begin{figure}[H]
			\includegraphics[width=\textwidth]{slike/Relacijska_shema.JPG} %veličina u odnosu na širinu linije
			\caption{Relacijska shema baze podataka}
			\label{fig:relacijska_shema1} %label mora biti drugaciji za svaku sliku
		\end{figure}
		
		\begin{figure}[H]
			\includegraphics[width=\textwidth]{slike/ER_model_BP.JPG} %veličina u odnosu na širinu linije
