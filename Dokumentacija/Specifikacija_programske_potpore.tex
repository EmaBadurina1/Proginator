\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}			
			...
			\subsection{Obrasci uporabe}
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Pacijent unosi datum i na temelju njega bira ponuđene termine
				...
				\noindent \underbar{\textbf{UC11 - Prihvaćanje zahtjeva za terminom (\ref{fig:sekvencijski_dijagram_3})}}
				\begin{packed_item}
					
					\item \textbf{Glavni sudionik: }Djelatnik
					\item  \textbf{Cilj: }Prihvatiti/odbiti zahtjev za terminom na temelju raspoloživosti opreme i soba
					\item  \textbf{Sudionici: }Baza podataka
					\item  \textbf{Preduvjet: }
					\item[] \begin{packed_enum}
					...
					\item[] \begin{packed_enum}
						\item Djelatnik odabire opciju "Zahtjevi"
						\item Prikaz stranice sa zahtjevima
						\item Djelatnik odabire opciju evidentiraj pored zahtjeva 
						\item Djelatniku se prikazuju moguće vrste opreme 
						\item Djelatnik odabire vrstu opreme
						\item Prikaz slobodnih prostorija s odabranom vrstom opreme
						\item Djelatnik odabire prostoriju i opcionalno piše komentar za pacijenta
						...
						\item Prikazuje se popis zahtjeva za terminom
					\end{packed_enum}
					
					\item  \textbf{Opis mogućih odstupanja:}
					
					\item[] \begin{packed_enum}
						\item[5.a] Nema slobodnih soba za tu vrstu opreme
						\item[] \begin{packed_enum}
							\item Djelatnik odbija zahtjev za terminom
							\item Otvara se prozor za dodjeljivanje novog termina s podacima o odabranom pacijentu, vrsti opreme i sljedećim slobodnim terminima
							\item Djelatnik odabire slijedeći slobodni termin
							\item Djelatnik dodaje komentar
							\item Djelatnik potvrđuje novi termin
							\item Sustav šalje pacijentu e-mail o dodjeljenom terminu
							\item Prikazuje se popis zahtjeva za terminom
			...
			\end{packed_item}
				...
				\noindent \underbar{\textbf{UC17 - Promjena dostupnosti opreme}}
				\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC19 - Promjena dostupnosti prostorije}}
				\begin{packed_item}
			...
			\subsection{Sekvencijski dijagrami}
				...
				Pacijent šalje zahtjev poslužitelju za naručivanje na terapiju. Web aplikacija mu prikazuje obrazac koji mora ispuniti kako i se naručio na terapiju. Pacijent unosi potrebne podatke(ime i prezime liječnika koji ga je uputio na rehabilitaciju, vrstu terapije, opis oboljenja i zahtjevani postupak liječenja). Pacijent šalje popunjeni obrazac. Web aplikacija na temelju primljenih podataka provjerava krebilitet liječnika u imeniku liječnika. Ovisno o rezultatu promjene web aplikacija će učiniti jednu od dvije stvari. Ako liječnik postoji u imeniku liječnika web-aplikacija sprema sve podatke u bazu podataka i prikazuje stranicu za odabir termina. U slučaju da liječnik ne postoji u imeniku liječnika aplikacija ispisuje poruku "Liječnik ne postoji", pacijent u tom slučaju mijenja podatke u slučaju da je krivo unio liječnika ili odustaje od prijavljivanja terapije.
				...
				\textbf{\underbar{UC11 - Prihvaćanje zahtjeva za terminom}}
				
				Djelatnik zatražuje najnovije zahtjeva za terminom, web aplikacija ih dohvaća iz baze podataka, web aplikacija prikazuje zahtjeve i podatke o njima: datum slanja zahtjeva, pacijenta, opis terapije i vrijeme željenog termina. Djelatnik odabire zahtjev koji će evidentirati klikom opcije "evidentiraj" pored zahtjeva, web aplikacija nakon toga dohvaća sve vrste opreme iz baze podataka i prikazuje ih. Djelatnik na temelju opisa terapije odabire potrebnu vrstu opreme na temelju čega će web aplikacija iz baze podataka dohvatiti slobodne sobe u željenom terminu s odabranom vrstom opreme, te ih prikazati djelatniku. Ako ima slobodnih soba u navedenom terminu djelatnik bira jednu od njih i dodaje komentar za pacijenta. Kada djelatnik odabere opciju "Potvrdi" web aplikacija u bazi podataka zauzima odabranu sobu i opremu za željeni termin, te šalje e-mail pacijentu s informacijama o terminu. Aplikacija potom dohvaća zahtjeve i prikazuje ih djelatniku. 
				
				U slučaju da nema slobodnih soba s tom vrstom opreme u željenom terminu djelatnik odbija zahtjev. Web aplikacija potom dohvaća prve slobodne termine za odabranu vrstu opreme nakon zatraženog termina, te prikazuje djelatniku obrazac za dodjelu termina. Djelatnik bira termin i dodaje komentar. Nakon potvrde zahtjev se modificira i postaje termin. Nakon što su podatci uspješno spremljeni u bazu podataka šalje se mail pacijentu s informacijama o dodjeljenom terminu. Aplikacija potom dohvaća zahtjeve i prikazuje ih djelatniku.
				
				\begin{figure}[H]
					\includegraphics[scale=0.4]{slike/UC11_Prihvaćanje_zahtjeva_za_termin.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
					\caption{Sekvencijski dijagram za UC11}
					\label{fig:sekvencijski_dijagram_3}
				\end{figure}
				\eject
				
				\textbf{\underbar{UC20 - Obavijest o promjeni termina}}
				
				Administrator na svojoj stranicu odabire opciju "Promjeni termin" te mu nakon toga web aplikacija otvara stranicu za promjenu termina. Administrator unosi pacijenta i pretražuje. Web aplikacija prima podatak i provjerava u bazi podataka ako pacijent postoji. Ako postoji web aplikacija odmah dohvaća neevidentirane termine odabranog pacijenta, te ih prikazuje administratoru. Administrator potom odabire termin koji želi promijeniti i web aplikacija mu pokazuje obrazac za dodjelu novog termina. Administrator unosi podatke o novom terminu (datum/soba/oprema) i aplikacija na temelju toga dohvaća moguće termine iz baze podataka. Administrator odabire neki od mogućih termina i opcionalno dodaje komentar. Nakon što administrator potvrdi odabrani termin web aplikacija dodaje termin u bazu podataka i šalje e-mail pacijentu s informacijama o promjeni termina, a administratoru se ponovno prikazuje stranica za promjenu termina. 
				
				U slučaju da pacijent kojeg je administrator unio ne postoji u bazi podataka aplikacija će ga obavijestiti o nepostojanju pacijenta. Nakon toga administrator ima dvije opcije: ponovno unijeti pacijenta ili odustati od promjene termina nakon čega mu se prikazuje početna stranica.
				
				\begin{figure}[H]
					\includegraphics[scale=0.4]{slike/UC20_Obavijest_o_promjeni_termina.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
		...
		\section{Ostali zahtjevi}
			 ...
			 \begin{packed_item}
			 	...
			 	\item Sustav mora biti dostupan korisnicima barem 90\% vremena unutar jedne godine.
