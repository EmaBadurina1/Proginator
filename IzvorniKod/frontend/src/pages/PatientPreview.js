...
import { TableContainer, Table, TableBody, TableHead, TableRow, InputAdornment } from "@mui/material";
                ...
                <Table>
                    ...
                    <TableBody>
                        {patients && patients.map((patient) => (
                            ...
                            <TableCell style={cellStyle2}>{patient.date_of_birth}</TableCell>
                            <TableCell style={cellStyle2}>{patient.email}</TableCell>
                            <TableCell style={cellStyle2}>{patient.phone_number}</TableCell>
